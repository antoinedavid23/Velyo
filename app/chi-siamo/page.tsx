...
export const metadata: Metadata = pageMetadata({ title: "Velyo, property manager a Genova", description: "Découvrez la méthode Velyo : une présence locale à Genova pour gérer les locations, coordonner les intervenants et protéger chaque bien.", path: "/chi-siamo" });

export default function Page() {
  return <ItalianContent>
    <PageHero label="Pourquoi Velyo existe" title="À propos" text="Une personne sur place pour gérer la location, suivre le bien et vous tenir informé." image="/images/concierge/owner-conversation-premium.webp" />

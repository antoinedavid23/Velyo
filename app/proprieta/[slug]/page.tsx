...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <ItalianContent><><PageHero label={property.location} title={property.name} text={property.shortDescription || "Un bien présenté avec soin par Velyo."} image={property.image} />

...
export const metadata: Metadata = {
  ...
  description: "Strumento decisionale privato per la crescita di VELYO a Genova.",
  robots: { index: false, follow: false, nocache: true },
  openGraph: {
    title: "VELYO · Strategia privata Genova",
    description: "Custodia patrimoniale. Controllo. Performance.",
    type: "website",
    locale: "it_IT",
    images: [{ url: "/strategia-og.png", width: 1745, height: 909, alt: "VELYO — Strategia privata Genova" }],
  },
  twitter: {
...
const offers = [
  ...
  ["Frequente","Dashboard e reporting","Molto rilevante per multiproprietari. Oggi è un’aspettativa; Velyo deve renderla più decisionale."],
...
const angles = [
  ...
  ["Protezione del bene","Frequente","Attiva avversione alla perdita. Velyo può possedere questo territorio con protocolli verificabili."],
...
const ads: Ad[] = [
  ...
  {title:"Proprietario all’estero",hook:"La tua casa è a Genova. Il tuo referente anche.",angle:"Presenza locale",promise:"Gestione trilingue e presenza operativa.",body:"Per chi vive fuori città o all’estero, Velyo coordina ospiti e casa in italiano, francese e inglese, con aggiornamenti chiari e un solo punto di contatto.",cta:"Prenota un confronto da remoto",creative:"Genova + video call + report, tono sobrio.",audience:"Espatriati e italiani residenti all’estero",format:"Video 20 s"},
  {title:"Portafoglio, non somma di case",hook:"Un portafoglio richiede priorità, non solo report.",angle:"Investor operations",promise:"Confronto tra immobili e azioni prioritarie.",body:"Velyo consolida occupazione, ADR, ricavi, incidenti e interventi per mostrare dove agire. Meno fogli separati, più decisioni.",cta:"Richiedi il modello Portfolio",creative:"Ranking di tre immobili con prossima azione.",audience:"Investitori con 3+ unità",format:"Documento ads / carousel"},
  {title:"Periodi vuoti, decisioni migliori",hook:"Il calendario vuoto non si riempie con uno sconto automatico.",angle:"Revenue management",promise:"Prezzo, restrizioni e posizionamento letti insieme.",body:"Velyo combina domanda, caratteristiche del bene e qualità dell’annuncio. L’obiettivo non è occupare a ogni costo, ma migliorare il valore netto e la coerenza degli ospiti.",cta:"Fai analizzare il calendario",creative:"Calendario con tre leve annotate.",audience:"Host con annunci già attivi",format:"Video whiteboard 25 s"},
  {title:"Pricing con un limite",hook:"Il prezzo giusto non deve sacrificare la casa.",angle:"Performance responsabile",promise:"Ottimizzazione con guardrail qualitativi.",body:"Una strategia premium considera ADR, occupazione, durata, rischio operativo e usura. Velyo non insegue il volume quando distrugge il valore.",cta:"Scopri i guardrail",creative:"Bilancia visiva: ricavo netto / qualità / usura.",audience:"Proprietari premium scettici sul mass market",format:"Immagine editoriale"},
  ...
  {title:"Prima e dopo la delega",hook:"Prima: tutto passa da te. Dopo: solo le decisioni importanti.",angle:"Contrasto",promise:"Riduzione del carico operativo.",body:"Velyo assorbe richieste ospiti, coordinamento e controlli. Tu mantieni regole, budget e visibilità. È questa la differenza tra delegare e sparire.",cta:"Mappa il tuo carico operativo",creative:"Split screen giornata del proprietario.",audience:"Host self-managed",format:"Reel 15 s"},
...
export default async function StrategyPage() {
  ...
  return <div className={styles.page} data-no-translate>
    <header className={styles.hero}>
      <div className={styles.heroTop}><span className={styles.brand}>VELYO · STRATEGIA RISERVATA</span><Link className={styles.back} href="/administration">Torna all’amministrazione</Link></div>
    ...
    <main className={styles.main}>
      <section id="decisione" className={styles.section}>
        <SectionHeader index="00" title="La tesi in una frase">Il mercato vende rendimento e assenza di stress. Velyo deve vendere una forma superiore di delega: il bene è protetto, il proprietario conserva il controllo e una persona risponde del risultato.</SectionHeader>
      ...
      <section id="economia" className={styles.section}>
        <SectionHeader index="01" title="Reality check economico">Il target “200 k€/mese” deve essere definito come GMV delle prenotazioni o ricavi Velyo. Con 50 immobili e ADR 150 €, le due letture producono economie radicalmente diverse.</SectionHeader>
        <StrategyEconomics/>
        <div className={styles.callout} style={{marginTop:18}}><strong>Raccomandazione di pianificazione</strong><p>Trattare 200 k€ come GMV mensile del portafoglio. A 70% di occupazione, 50 immobili richiedono circa 190 € di ADR; a 150 € di ADR servirebbe circa 89% di occupazione. Il piano base prudente è 150–180 k€ GMV e 37,5–45 k€ di ricavi Velyo al 25%, prima di servizi accessori.</p></div>
      ...
      <section id="swot" className={styles.section}>
        <SectionHeader index="02" title="SWOT completo di Velyo">L’analisi combina convergenze dei concorrenti, audit del sito e vincoli dichiarati. Le conseguenze business sono esplicite per evitare un SWOT decorativo.</SectionHeader>
      ...
      <section id="concorrenti" className={styles.section}>
        ...
        <div className={styles.tableWrap}><table className={styles.table}><thead><tr><th>Attore</th><th>Promessa / valore</th><th>Cliente / gamma</th><th>Prova visibile</th><th>Genova</th><th>Prezzo pubblico</th><th>Lettura Velyo</th></tr></thead><tbody>{competitors.map((item)=><tr key={item.name}><td><a href={item.url} target="_blank" rel="noreferrer"><b>{item.name}</b></a></td><td>{item.promise}</td><td>{item.client}<br/><span className={styles.confidence}>{item.level}</span></td><td>{item.proof}</td><td>{item.genova}</td><td>{item.price}</td><td>{item.lesson}</td></tr>)}</tbody></table></div>
        <div className={styles.callout} style={{marginTop:18}}><strong>Sintesi</strong><p>Wonderful Italy possiede la scala; Italianway la piattaforma; Owner Value la trasparenza locale; AlterEgo l’esclusività dichiarata. Velyo deve possedere l’intersezione che nessuno dimostra completamente: Genova + custodia patrimoniale + controllo multi-bene + responsabilità personale.</p></div>
      </section>
      ...
      <section id="offerta" className={styles.section}>
        ...
        <div className={styles.grid3} style={{marginTop:18}}>
          <article className={styles.card}><h3>Velyo Custodia · 25%</h3><p>Flagship: gestione completa, pricing, ospiti, Traveler Select, controlli, manutenzione coordinata, report mensile e referente unico.</p><span className={styles.verdict}>Base consigliata; percentuale sul solo ricavo alloggio, IVA e pass-through espliciti.</span></article>
          <article className={`${styles.card} ${styles.darkCard}`}><h3>Velyo Portfolio · 22–24%</h3><p>Per 2+ unità: reporting consolidato, soglie di autorizzazione, review trimestrale e priorità per portafoglio.</p><span className={styles.verdict}>Sconto solo contro densità, standardizzazione e minimo mensile per unità.</span></article>
          <article className={styles.card}><h3>Velyo Signature · 28–32%</h3><p>Villa o bene complesso: standard personalizzati, controllo inventario rafforzato, concierge e manutenzione pianificata.</p><span className={styles.verdict}>Su audit; servizi eccezionali e costi terzi approvati separatamente.</span></article>
        </div>
      ...
      <section id="marketing" className={styles.section}>
        ...
        <div className={styles.callout} style={{marginTop:18}}><strong>Divergenza da non ignorare</strong><p>Tilo dichiara fino al +50% e il sito Velyo mostra +71%, mentre la fonte AirDNA del notebook è in errore e il corpus non contiene un benchmark comparabile per Genova. Sono claim di marca, non prove convergenti: Velyo deve sostituire l’uplift assoluto con una forchetta, ipotesi visibili e casi verificati.</p></div>
      </section>

      <section id="copy" className={styles.section}>
        <SectionHeader index="06" title="Sistema di messaggi Velyo">Il copy deve prima rendere chiari categoria, area e risultato; il linguaggio evocativo viene dopo. Tutto il percorso, incluse email e validazioni, deve essere italiano nativo.</SectionHeader>
        <div className={styles.message}><small>Messaggio principale raccomandato</small><blockquote>La gestione completa che protegge il tuo immobile e ti restituisce il controllo.</blockquote><p>A Genova, Velyo coordina casa, ospiti, performance e partner con un referente unico, un protocollo di custodia e un reporting pensato per proprietari e portafogli.</p></div>
      ...
      <section id="ads" className={styles.section}>
        <SectionHeader index="07" title="30 Ads pronte da testare">Queste sono proposte Velyo, non annunci attribuiti ai concorrenti. L’ordine di test parte da controllo, custodia e diagnosi; i casi risultato restano vietati finché non esistono prove verificabili.</SectionHeader>
      ...
      <section id="landing" className={styles.section}>
        ...
        <div className={styles.sequence}>
          {[
            ...
            ["Sistema Velyo","Custodia, Traveler Select, Performance e Command Center. Quattro moduli, una responsabilità."],
      ...
      <section id="oceano" className={styles.section}>
        <SectionHeader index="11" title="Blue Ocean: Velyo Private Portfolio">L’offerta difficile da copiare non è una lista di servizi. È un sistema proprietario che accumula conoscenza dell’immobile, rende la qualità visibile e consolida le decisioni del proprietario.</SectionHeader>
      ...
      <section id="genova" className={styles.section}>
        <SectionHeader index="12" title="Applicazione rigorosa a Genova">Il Comune punta su turismo di qualità, tutte le stagioni e maggiore internazionalizzazione. Velyo deve trasformare questi segnali in un prodotto locale, senza allargarsi prematuramente a tutta la Liguria.</SectionHeader>
        <div className={styles.grid3}>
